...
RUN apt install  -y python3-pyqt6 python3-tk libqt6webchannel6 libqt6webview6
...
RUN apt install  -y git git-extras lintian

#RUN apt install  -y python3-pyinstaller
