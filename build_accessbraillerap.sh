...
printf "\e[1;34m####################################\e[0m\n"
printf "\e[1;34minstall python dependencies Debian13\e[0m\n" 
printf "\e[1;34m####################################\e[0m\n"
pip install -r /home/builduser/AccessBrailleRAP/requirement_debian13.txt
...
#npm run builddebian
 ...
 if [ $(find /home/builduser/AccessBrailleRAP/dist/ -name "accessbraillerap-debian-*.deb") ];
  then
    ...
    cp  /home/builduser/AccessBrailleRAP/dist/requirement_test.txt /home/builduser/dist/requirement_test.txt
